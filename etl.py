...
def process_song_file(cur, filepath):
    """This function will read the file in json parsing, and transform and ingest it in the tables songs and artists."""
    # open song file
...
def process_log_file(cur, filepath):
    """This function will read the file in json parsing, and transform and ingest it in the tables time, users and songplays."""
    # open log file
    df = pd.read_json(filepath, lines=True)
...
def process_data(cur, conn, filepath, func):
    """This function will read get all the files in the main directory and process every file to ingest it in the corresponding table."""
...
def main():
    """This main function will ingest the data in the main tables for Sparkfy. It asumes that the main tables are already created."""
