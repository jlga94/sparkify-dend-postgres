...
def create_database():
    """This functions creates the connection with the Database studentdb, and drop and creates the the database sparkifydb"""
...
def main():
    """This is the main function. that creates the database, drops tables and creates tables."""
